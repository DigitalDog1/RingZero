...
*(Внимание: замените ссылку выше на реальную ссылку на ваш раздел Releases)*
...
### Шаг 1: Установка
1. Перейдите в раздел [Releases](https://github.com/ТВОЙ_НИК/RingZero/releases) справа на этой странице.
